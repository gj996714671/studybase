...
if($config->checkVersion and isset($_SERVER['https']))  js::import("https://api.zdoo.org/updater-latest-{$config->version}.html");
if($config->checkVersion and !isset($_SERVER['https'])) js::import("http://api.zdoo.org/updater-latest-{$config->version}.html");
